## 6. LoRA
 ...
 LoRA部分的教程来自：【[传送门](https://github.com/hans0809/MiniMind-in-Depth/blob/main/src/11-LoRA-LLM%E8%BD%BB%E9%87%8F%E5%8C%96%E5%BE%AE%E8%B0%83%E7%9A%84%E5%88%A9%E5%99%A8.md)】 
...
![](assets/6.LoRA/1XdoGFaSME49GrqfBPGJqdQ.webp)
...
原先微调需要更新整个 $W$，其参数量为 $\text{Param}(W) = d_{\text{out}} \times d_{\text{in}}$，使用LoRA后， $BA$ 的参数量仅为 
...
```python
state_dict 中有这些 key：
    "linear.lora.A.weight" → tensor(...)
    "linear.lora.B.weight" → tensor(...)
...
而 module.lora.state_dict().keys() 正是：
    "A.weight", "B.weight"
...
![image-20251215132509710](assets/6.LoRA/image-20251215132509710.png)
